            ...
            <div class="card-container card">
                <Form class="flex flex-col items-center" @submit="handleForgotPassword" :validation-schema="schema">
                    ...
                    <div class="form-group w-40 self-center">
                        <button class="btn btn-accent btn-block mt-4 text-base font-bold text-primary" :disabled="loading">
                            <div v-show="loading">
                            ...
                            <div v-show="!loading">Próximo</div>
                        </button>
                    </div>
                </Form>
...
export default {
    ...
    data() {
        const schema = yup.object().shape({
            email: yup
                ...
                .email("Email informado é invalido!")
                .max(50, "Excedido o máximo de 50 caracteres!")
        });
    ...
    methods: {
        handleForgotPassword(data) {
            ...
            ForgotPasswordService.send(data.email).then((result) => {
