...
export default {
            ...
            columns: [
                ...
                },
                {
                    ...
                    cellTemplate: (createElement, props) => {
                        return createElement('div', {},
                            createElement('a', {
                                href: `/admin/adminUserDashboard/${props.model.id}`,
                                class: {
                                    'btn': true,
                                    'btn-sm': true
                                },
    ...
    methods: {
        ...
        /**
         * Show the edit modal and populate it with the given data.
         *
         * @param {Object} data - The data to populate the edit modal with.
         */
        showEditModal(data) {
            this.message = "";
            this.successful = false;
        ...
        /**
         * Sorts two objects based on the value of a specified property.
         *
         * @param {string} prop - The name of the property used for sorting.
